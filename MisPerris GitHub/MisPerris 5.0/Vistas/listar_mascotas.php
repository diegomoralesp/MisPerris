...
<body bgcolor="FCFCFC">
    ...
    <center>
        ...
        <table class="table">
            ...
            fwrite($archivo, "idmascota;fecha_ingreso;nombre;edad;raza;observacion;sexo \n");
            while ($row = mysqli_fetch_array($reg)) {
                ...
                echo '<td>' . $row[5] . "</td>";
                echo '<td>' . $row[6] . "</td>";
                echo '<td><a href="f_m_eliminar.php?idmascota=' . $row[0] . '"> Eliminar </a></td>';
                echo '<td><a href="mod_mascota.php?idmascota=' . $row[0] . '"> Modificar </a></td>';
                echo '</tr>';
